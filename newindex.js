...
import Eight from './newlottiefiles/8.json'
import Nine from './newlottiefiles/9.json'
...
import Fourteen from './newlottiefiles/14.json'
import Fifteen from './newlottiefiles/15.json'
